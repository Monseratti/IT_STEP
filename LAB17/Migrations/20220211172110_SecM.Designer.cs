...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LAB17.Classes.Autos", b =>
                {
                    b.HasOne("LAB17.Classes.Clients", "Clients")
                        .WithMany("Autos")
            ...
            modelBuilder.Entity("LAB17.Classes.Orders", b =>
                {
                    b.HasOne("LAB17.Classes.Autos", "Autos")
                        .WithMany("Orders")
                        .HasForeignKey("AutosId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LAB17.Classes.Servises", "Servises")
                        .WithMany("Orders")
                        .HasForeignKey("ServisesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LAB17.Classes.Workers", "Workers")
                        .WithMany("Orders")
